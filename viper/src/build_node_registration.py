...
registration_contract_address, registration_contract_abi = deployer.deploy("contracts/test.v.py", None)
                                                                           #token_contract_address) "contracts/node_registration.v.py"
